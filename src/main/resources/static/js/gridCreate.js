class GridCreator
{
    ...
    #updateToPixels(grid)
    {
        grid.style.gridTemplateRows = "repeat(" + this.#x + "," + grid.clientHeight /  this.#x +"px)";
        grid.style.gridTemplateColumns = "repeat(" + this.#y + "," + grid.clientWidth /  this.#y +"px)";
    }
}
